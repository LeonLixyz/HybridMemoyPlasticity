...
from Memory_Networks.Memo import Memo
from Memory_Networks.Stack import Stack
from Memory_Networks.Dyn_RO import Dyn_RO
from Memory_Networks.Nonl_RO import Nonl_RO
...
def network_selector(input_dim, hid_dim_list, out_dim, hetero_list, plastic_list, network_name):
    if network_name == 'Memo':
        return Memo(input_dim, hid_dim_list, out_dim, hetero_list, plastic_list)
